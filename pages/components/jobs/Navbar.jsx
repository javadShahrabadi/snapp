        ...
        <div className=" flex-row space-x-4 items-center hidden lg:flex">
          ...
          <span className="cursor-pointer me-4 ">
            <svg
              ...
              viewBox="0 0 16 16"
              className="hover:fill-[#00AF4B] transition-colors ease-in-out duration-200"
            >
          ...
          <span className="cursor-pointer">
            <svg
              ...
              viewBox="0 0 16 16"
              className="cursor-pointer hover:fill-[#00AF4B] transition-colors ease-in-out duration-200"
            >
